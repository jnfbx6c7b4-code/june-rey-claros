...
jQuery(document).ready(function($) {
    ...
    var stellarnav =  $('.stellarnav');
      stellarnav.stellarNav({
        ...
        breakpoint: 960,
        position: 'right',
        phoneBtn: '+639242105866',
        locationBtn: 'https://www.google.com/maps/place/Butuan+City'
      });
    ...
    //current class adding -- only for in-page section links (href="#section").
    //Cross-page links such as index.html#about must keep their default behaviour,
    //otherwise onePageNav swallows the click and tries to scroll to a missing target.
    ...
    //start on whichever tab is marked active instead of always showing everything
    portfolio_list.isotope({
        filter: portfolio_filter.filter(".active").attr("data-filter") || '*',
        layoutMode: 'masonry',
        masonry: {
            columnWidth: '.col-md-4',
            horizontalOrder:false,
